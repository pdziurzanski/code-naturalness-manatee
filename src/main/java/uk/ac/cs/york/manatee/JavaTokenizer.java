...
public class JavaTokenizer implements ITokenizer {
	...
	protected PublicScanner prepareScanner() {
		final PublicScanner scanner = new PublicScanner(false /*comment*/, false /*whitespace*/, false /*nls*/, ClassFileConstants.JDK1_8 /*sourceLevel*/, null/*taskTag*/, null/*taskPriorities*/, true /*taskCaseSensitive*/);
